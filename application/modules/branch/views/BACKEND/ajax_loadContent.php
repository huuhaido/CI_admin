							...
							<table class="table table-striped table-bordered table-hover dataTable no-footer">
								<thead>
									<tr role="row">
										...
										<th class="sorting" width="200" onclick="sort('name')" id="name">Name</th>
										<th class="sorting_disabled">Address</th>
										<th class="center sorting_disabled" width="100">Phone</th>
										<th class="center sorting" width="70" onclick="sort('order')" id="order">Order</th>
